...
Public Class FormMS                                                    ''~1807I~
    ...
    Private Sub FormMS_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load ''~1807I~
        Trace.W("FormMS_Load entry")                                   ''~1807M~
        Try                                                            ''~1807M~
        ...
        End Try                                                        ''~1807I~
        Trace.W("FormMS_Load exit")                                    ''~1807I~
    End Sub                                                            ''~1807I~
    '**************************************************                ''~1807I~
    ...
    Public Sub setImage(Pfnms() As String, PswForm2 As Boolean)         ''~1807R~
        Trace.W("FormMS.ShowMS entry")                                 ''~1807I~
        ...
        Trace.W("FormMS.ShowMS exit")                                  ''~1807R~
    End Sub                                                            ''~1807I~
    '**************************************************                ''~1807I~
    Public Sub setupForm()                                             ''~1807R~
        Trace.W("FormMS.setupForm entry swFromForm2=" & swFromForm2)   ''~1807R~
        ...
        Trace.W("FormMS.setupForm ix\dxLang=" & idxLang)               ''~1807R~
    End Sub                                                            ''~1807I~
    '**************************************************                ''~1807I~
    Private Sub setFilename()                                          ''~1807I~
        Trace.W("FormMS.setFilename entry")                            ''~1807I~
        ...
        Trace.W("FormMS.setFilename exit input=" & ifnms)              ''~1807I~
    End Sub                                                            ''~1807I~
    '**************************************************                ''~v110I~''~1807I~
    ...
    Private Sub On_Extract_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItemExtract.Click  ''~1807I~
        Trace.W("FormMS.On_extract_Click entry")                       ''~1807I~
        Try                                                            ''~1807I~
            image2Text()                                               ''~1807R~
            updateMRU()                                               ''~1807I~
            Dispose()                                                  ''~1807I~
    ...
    Private Sub updateMRU()                                            ''~1807I~
        Trace.W("FormMS.updateMRU entry")                              ''~1807I~
        For ii As Integer = 0 To ctrFiles - 1                          ''~1807I~
            Dim fnm As String = imageFiles(ii)                                       ''~1807I~
            aForm1.insertMRUList(1, fnm)      '1:imagefile                    ''~1807I~''~1808R~
            Trace.W("FormMS.updateMRU insert fnm=" & fnm)              ''~1807I~
        Next                                                           ''~1807I~
        Trace.W("FormMS.updateMRU exit")                               ''~1807I~
    End Sub                                                            ''~1807I~
    '*************************************************************     ''~1807I~
    Private Sub image2Text()                                           ''~1807I~
        Trace.W("FormMS.image2Text entry ctrFiles=" & ctrFiles)        ''~1807I~
        ...
        Trace.W("FormMS.image2Text exit")                              ''~1807I~
    End Sub                                                            ''~1807I~
    '*************************************************************     ''~1807I~
    ...
    Private Sub image2Text(Pfnm As String)                             ''~1807I~
        Trace.W("FormMS.image2Text entry fnm=" & Pfnm)                 ''~1807I~
        xText = aaForm2.Image2TextMultiSelect(Pfnm, langTag)                      ''~1807I~''~1808R~
        Trace.W("FormMS.image2Text exit fnm=" & Pfnm & ",text=" & xText) ''~1807R~
    End Sub                                                            ''~1807I~
    '**************************************************                ''~1807I~
